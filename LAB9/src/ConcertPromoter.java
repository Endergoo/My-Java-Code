...
public class ConcertPromoter {
	...
	public static void main(String[] args) {
		...
		while(input.equalsIgnoreCase("quit")!= true)
		{
			...
			System.out.println("Has sold "+concert.getTicketsSoldByPhone()+" tickets by phone");
			System.out.println("Has sold "+concert.getTicketsSoldAtVenue()+" tickets at the venue");
